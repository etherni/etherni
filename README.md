...
Currently embedded in the **ZK and AI agent ecosystem** - working across [Metis Foundation](https://metis.foundation),  [Metis L2](https://metis.io), [ZKM](https://zkm.io), and [GOAT Network](https://goat.network), and maintaining the ops infrastructure for [CryptoChicks](https://cryptochicks.ca).

---

## Current Projects

### 🔐 Zero-Standing-Privilege Governance Framework
...
### 🎯 Grant Co-Application Discovery Agent
...
I write about organizational failures through this lens at the [Operators Guild](https://forum.ceg.vote/c/community-hub/guilds/operators-guild/51) - specifically the ones where the post-mortem everyone published missed the actual cause.
...
<sub>Opinions are my own. Frameworks are open source. Accountability is non-negotiable.</sub>
